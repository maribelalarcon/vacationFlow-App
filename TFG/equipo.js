...
//
//   Las solicitudes de vacaciones quedan pendientes de
//   un endpoint GET /solicitudes/equipo que aún no existe.
// ═══════════════════════════════════════════════════════
...
function crearFila(u) {
  ...
  tr.innerHTML = `
    ...
    <td>${u.desde}</td>
    <td>${u.hasta}</td>
    <td><span style="color:var(--gray-400);font-size:12px;">Sin solicitudes</span></td>
  `;
